...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.government.taxLevel = 5.2;
    self.government.averagePrice = 18;
    self.government.taxLevel = 5.3;
    self.government.averagePrice = 15;
    self.government.taxLevel = 5.6;
    self.government.averagePrice = 14;
    self.government.taxLevel = 5.4;
    self.government.averagePrice = 18;
    self.government.taxLevel = 5.5;
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    NSLog(@"applicationDidEnterBackground - METHOD");
}


- (void)applicationWillEnterForeground:(UIApplication *)application {
    // Called as part of the transition from the background to the active state; here you can undo many of the changes made on entering the background.
    NSLog(@"applicationWillEnterForeground - METHOD");
}
